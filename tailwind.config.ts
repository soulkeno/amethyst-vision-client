	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-intense': {
					'0%, 100%': { 
						textShadow: '0 0 20px hsl(271 91% 65% / 0.8), 0 0 40px hsl(316 73% 69% / 0.4)',
						filter: 'brightness(1)'
					},
					'50%': { 
						textShadow: '0 0 30px hsl(271 91% 65% / 1), 0 0 60px hsl(316 73% 69% / 0.8), 0 0 80px hsl(271 91% 65% / 0.4)',
